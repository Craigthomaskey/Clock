...
namespace Clock
{
    class HDCountdowns
    {
        ...
        List<DateTime> TimeList = new List<DateTime>()
        {
             ...
             new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 11, 59, 00),
             new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 12, 00, 00),
             new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 12, 05, 00),
             new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 12, 15, 00),             
        };
        List<string> PhraseList = new List<string>() { "Markets Open", "Grains Open", "Snack Time!", "Report", "Closing Periods", "No Filter", "Grain Markets Closed", "Good Night!" };
        ...
        int TimerIndex { get { return TimeList.IndexOf(CurrentTimer); } }
        ...
        public void Init(Form1 f1) { MainForm = f1; SetUpTimer(); }
        ...
        void TimerLapse()
        {
            ...
            if (CorrectSettings && Properties.Settings.Default.HalfDay && Properties.Settings.Default.Sounds)
            {
                ...
                if (sound == "0 seconds.mp3")
                {
                    ...
                    FileName = @"C:\Users\" + System.Environment.UserName + @"\Documents\KDM\Sounds\HDBuzzers\" + Properties.Settings.Default.SoundType + @"\" + "Buzzer " + TimerIndex.ToString() + ".mp3";
